...
main_depart = pd.read_excel(DIR_DESKTOP + "稽核/仓库/基础数据.xlsx", sheet_name="部门")
detail = pd.read_excel(DIR_DESKTOP + "落单明细.xlsx")
...
task_week = pd.read_excel(DIR_DESKTOP + "/稽核/周报/每周任务.xlsx", sheet_name='周任务')
task_month = pd.read_excel(DIR_DESKTOP + "/稽核/周报/每周任务.xlsx", sheet_name='月任务')
...
total_achieve.to_excel(DIR_DESKTOP + "稽核/仓库/业绩汇总表.xlsx", sheet_name='汇总', index=False)
