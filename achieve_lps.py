...
detail = pd.read_excel(DIR_DESKTOP + "/下载/落单明细_lps.xlsx", convert_float=False, skipfooter=1)
table = pd.read_excel(DIR_DESKTOP + "/下载/营业日报_lps.xlsx", header=None, skipfooter=1)
